...
- [x] **Step 3: Define the shared contracts**
...
- [x] **Step 4: Implement and export Zod schemas**
...
- [x] **Step 3: Implement deterministic stream derivation**
...
- [x] **Step 4: Implement the pure solving functions**
...
- [x] **Step 5: Run focused tests and inspect deterministic JSON**
...
- [x] **Step 3: Implement question instantiation and participant simulation**
...
- [x] **Step 4: Implement standings and report validation**
...
- [x] **Step 5: Run deterministic and statistical tests**
...
- [x] **Step 1: Write failing duel tests**
...
- [x] **Step 3: Implement alternating rounds and scoring**
...
- [x] **Step 4: Implement tiebreak dispatch**
...
- [x] **Step 5: Validate report and run tests**
...
- [x] **Step 1: Add failing importer and NPC tests**
...
- [x] **Step 3: Extend schema, loader, and reconciliation**
...
- [x] **Step 4: Implement NPC generation**
...
- [x] **Step 5: Run tests, typecheck and migration validation**
...
- [x] **Step 3: Add Prisma enums and models**
...
- [x] **Step 5: Implement repository methods and tests**
...
- [x] **Step 1: Write failing API and reward tests**
...
- [x] **Step 3: Implement stage overview and progress projection**
...
- [x] **Step 4: Implement transactional stage entry**
...
- [x] **Step 5: Implement reward and NG+ calculations**

Read money, item, milestone, full-clear and NG+ values from CONFIG; apply the documented layer multiplier to money and eligible rewards, exempt advance-stone/legend-box milestone items where specified, and use conditional updates/upserts. Detect all eight chapter-final first clears at `ngLevel=0`; award full-clear rewards exactly once and make NG+ level 1 available. Track each NG layer independently and require the previous layer's eight chapter finals before opening the next.

- [x] **Step 6: Add routes and record retrieval**
...
- [x] **Step 1: Implement typed query/mutation hooks**
...
- [x] **Step 2: Build the story stage tree**
...
- [x] **Step 3: Build the report renderer**
...
- [x] **Step 4: Wire routes and empty/loading/error states**
...
- [x] **Step 5: Run build and manual smoke**
...
- [x] **Step 1: Add consolidated golden and end-to-end assertions**
...
- [x] **Step 3: Run HTTP smoke checks**
...
- [x] **Step 4: Update the roadmap with evidence**
...
- [x] **Step 5: Commit the documentation and quality gate**
...
- [x] Every ROADMAP item T2.1–T2.8 maps to at least one task: T2.1→2, T2.2→3, T2.3→4, T2.4→5, T2.5→6–7, T2.6→8, T2.7→7, T2.8→7.
- [x] No task imports future PVP/adventure models; nullable future relationships remain outside M2.
- [x] The existing M1 `/api/problems` user-library endpoint remains distinct from the M2 configuration bundle.
- [x] All later interfaces match earlier names: `RankingInput`, `DuelInput`, `simulateRanking`, `simulateDuel`, `ContestReport`, `CONFIG.problems`, `CONFIG.stages`, repository methods, and story routes.
- [x] No placeholder terms such as TBD, TODO, or “implement later” remain in the plan.
- [x] Numerical rules point to `contest.md`, `progression.md`, or YAML rather than embedding new balance values.
- [x] The plan leaves no requirement without a testable task, and each task ends with a focused test or quality-gate command.
